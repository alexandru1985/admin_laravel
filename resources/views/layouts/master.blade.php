  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-gear"></i> <span>Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu remove-padding-left">
            <li>
                <router-link to="/users">
                    <i class="fa fa-users add-padding-left"></i><span class="add-padding-left">Users</span> 
                </router-link>
            </li>
        ...
        <li>
            <router-link to="/developer">
                <i class="fa fa-cogs"></i> <span>Developer</span>
            </router-link>
        </li>
        @endcan
        <li>          
        <a class="" href="{{ route('logout') }}"
           onclick="event.preventDefault();
             ...
             <i class="fa fa-power-off text-red"></i> <span>{{ __('Logout') }}</span>
        </a>
